...
export class AuthController {
  ...
  public async redirect(
    ...
    try {
      ...
      } = (await Axios.get(`https://slack.com/api/oauth.access?code=${ req.query.code }&client_id=${ process.env.SLACK_APP_CLIENT_ID }&client_secret=${ process.env.SLACK_APP_SECRET }&=redirect_uri=${ encodeURIComponent('https://6a3bdba0.ngrok.io/auth/redirect') }`)).data;
